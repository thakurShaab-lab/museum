...
router.get(
  "/visitors/:visitor_id/images/:image_index",
  apiKeyAuth("read:images"),
  validate(visitorImageParamsSchema, "params"),
  getVisitorImage
);

router.post(
  "/visitors/register",
  apiKeyAuth("register:visitors"),
  ...uploadVisitorImages,
  validate(registerVisitorSchema, "body"),
  registerVisitor
);
